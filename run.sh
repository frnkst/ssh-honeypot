...
docker run -d -p 5555:80 ghcr.io/frnkst/honeypot-frontend:2022-05-22t20-28_bfee435
docker run -d -p 3000:3000 ghcr.io/frnkst/honeypot-backend:2022-05-22t20-28_bfee435
