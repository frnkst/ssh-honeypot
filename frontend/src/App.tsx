...
async function getRecentAttempts() {
  const response = await fetch(`http://${window.location.hostname}:3000/recent`);
  return await response.json();
}

async function getBasicStats() {
  const response = await fetch(`http://${window.location.hostname}:3000/count`);
  return await response.json();
}

async function getUsernames() {
  const response = await fetch(`http://${window.location.hostname}:3000/usernames`);
  return await response.json();
}

async function getPasswords() {
  const response = await fetch(`http://${window.location.hostname}:3000/passwords`);
  return await response.json();
}

async function getIPs() {
  const response = await fetch(`http://${window.location.hostname}:3000/ip`);
  return await response.json();
}
